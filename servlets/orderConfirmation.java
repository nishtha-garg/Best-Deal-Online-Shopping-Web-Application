...
out.println("<tr>");
  ...
  out.println("<br>");
  out.println("<br>");
  out.println("<h1><font color='red'> your order has been confirmed!!!</font></h1>");
	...
	List<Integer> idList= service.insertOrders((String)session.getAttribute("username"), new ArrayList(mapp.values()));
	
	
	for(Integer i:idList)
	{
	
		 out.println("<h3> Order Id is " +  i + "</h3>"); 
	...
	out.println("<h3><font color='blue'>Expected Delivery date : " + output +"</font></h3>");
	mapp.clear();
