...
public class checkout extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
out.println("<head>");
out.println("<title>Checkout--homepage</title>");
...
out.println("<td colspan='3'><div class='style1' id='header'>");
    ...
    out.println("<tr>");
      ...
      out.println("<ul>");
      out.println("<li><a href='index2.html'>HOME</a></li>");
      out.println("<li><a href='index.html'>SIGNOUT</a></li>");
      out.println("<li><a href='NewAccount.html>NewAccount</a></li>");
    ...
    out.println("<tr>");
      ...
      out.println(" Enter your Billing Information!!! " +"</font>" + "</h1>");
      ...
      out.println("<tr>");
      out.println("<td><b>Product ID </b>" + "</td>" + "<td> <b>Product Retailer </b>"+"</td>"+"<td><b>Product Cost</b>"+ "</td>");
      out.println("</tr>");
  	...
  	{ 
  	System.out.println("Id is "+ p.getProductId() + " Retailer is " + p.getProductRetailer()+ " Price is " + p.getProductPrice()); 
  	out.println("<tr><td>" + p.getProductId() + "</td>" + "<td>" +  p.getProductRetailer()+ "</td>" + "<td>" + p.getProductPrice() + "</td></tr>"); 
  	...
  	out.println("<tr><td></td><td><b>Total Price</b></td><td>" + totalPrice + "</td></tr>"); 
  	
  	out.println("<tr><td><b>Credit Card No.</b></td><td><input type='text' size='50' name='credit card number'></td></tr>");
  	out.println("<tr><td><b>Address</b></td> <td><input type='text' size='50' name='billing address'></td></tr>");
  		
  		
  	out.println("<tr><td></td><td><input type='submit' value='Confirm'/></td></tr>");
  	out.println("</table>");
